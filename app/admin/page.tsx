    ...
    <div>
      ...
      <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6">
          <p className="text-sm text-muted">Usuarios totales (Mercue)</p>
          <p className="mt-2 text-3xl font-bold text-slate-900">{stats?.totalUsers ?? "—"}</p>
        </div>
      </div>

      <p className="mt-8 text-xs text-muted">
        Las estadísticas y reseñas se administran desde /admin/resenas en el proyecto Mercue, no aquí. Este panel
